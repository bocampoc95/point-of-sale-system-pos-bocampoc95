...
const Header =`
<div id="header" class="      bg-[#96bcf1] w-screen">
  <div class="    sm:w-full  flex items-center  justify-between p-1">
<div class="sm:justify-end lg:justify-between">
<nav class=" sm:flex gap-2 p-2 w-f ">
